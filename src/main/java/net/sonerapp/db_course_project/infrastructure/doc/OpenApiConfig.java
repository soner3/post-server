...
@OpenAPIDefinition(info = @Info(title = "DB Course Project API by Soner, Luis and Jeanette", license = @License(name = "MIT License", url = "https://opensource.org/license/mit"), description = "Documentation for all API endpoints of this project", version = "1.0"), servers = {
